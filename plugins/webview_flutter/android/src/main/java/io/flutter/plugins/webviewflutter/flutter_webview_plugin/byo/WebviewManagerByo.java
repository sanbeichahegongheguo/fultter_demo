...
public class WebviewManagerByo implements WebviewManagerInterface {
                    ...
                    switch (keyCode) {
                        case KeyEvent.KEYCODE_BACK:
                            if (webView.canGoBack()) {
                                Log.i("WebviewManager","canGoBack");
                                webView.evaluateJavascript("window.backFunc()", new ValueCallback<String>() {
                                    @Override
    ...
    public void eval(MethodCall call, final MethodChannel.Result result) {
     ...
     * Reloads the Webview.
     */
    public void reload(MethodCall call, MethodChannel.Result result) {
        if (webView != null) {
            webView.reload();
        }
    }
     ...
     */
    public void back(MethodCall call, MethodChannel.Result result) {
     ...
     */
    public void forward(MethodCall call, MethodChannel.Result result) {
    ...
    public void hide(MethodCall call, MethodChannel.Result result) {
        if (webView != null) {
            webView.setVisibility(View.GONE);
        }
    }
    ...
    public void stopLoading(MethodCall call, MethodChannel.Result result) {
        if (webView != null) {
            webView.stopLoading();
        }
    }

    public void cleanCookies(MethodCall call, final MethodChannel.Result result) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            CookieManager.getInstance().removeAllCookies(new ValueCallback<Boolean>() {
                @Override
                public void onReceiveValue(Boolean aBoolean) {

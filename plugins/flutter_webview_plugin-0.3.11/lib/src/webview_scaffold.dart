...
import 'package:flutter_webview_plugin/src/webview_server.dart';
import 'base.dart';
...
class _WebviewScaffoldState extends State<WebviewScaffold> {
  ...
  _WebviewScaffoldState() {
    WebviewServer.start().then((_port) => _portCompleter.complete(_port));
  }
                ...
                onRectChanged: (Rect value) {
                  if (_rect == null) {
                    ...
                    webviewReference.launch(
                      _getInitialUrl(widget.url,snap.data),
  ...
  String _getInitialUrl(String url, int port) {
    if (url != null) {
      ...
      if (u.isAbsolute || u.scheme == 'http' || u.scheme == 'https') {
        return url;
      } else {

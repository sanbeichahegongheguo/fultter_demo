...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction
    ...
    static NSString *endPayRedirectURL = nil;
     ...
     //h5回调拦截
      if ([scheme isEqualToString:@"haxecallback"] || [scheme isEqualToString:@"appcallback"]) {
        id h5data = @{@"url": navigationAction.request.URL.absoluteString,
                      @"type":@"stopLoad",
                      @"navigationType": [NSNumber numberWithInteger:navigationAction.navigationType]};
        [channel invokeMethod:@"onState" arguments:h5data];
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation {
    id data = @{@"url": webView.URL.absoluteString};

...
class BetterSocketV2 {
  static const MethodChannel _channel = const MethodChannel('better_socket_v2');
  static const EventChannel eventChannel = const EventChannel("better_socket_v2/event");
  ...
  static connentSocket(String path,
      {Map<String, String> httpHeaders, bool trustAllHost, String keyStorePath, String keyPassword, String storePassword, String keyStoreType}) {
  ...
  static void addListener({Function onOpen, Function onMessage, Function onError, Function onClose}) {
    _onOpen = onOpen;

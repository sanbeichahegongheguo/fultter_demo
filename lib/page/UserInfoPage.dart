                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  SizedBox(
                                    ...
                                    child: Text(
                                      "${store.state.userInfo.realName} 家长" ?? "",
...
//                      border: new Border.all(color: Color(0xFFa6a6a6)),
                  ...
                  Container(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        _getBt("所在学校", "images/admin/icon-school.png", null, store.state.userInfo.schoolName ?? "", 2),
                        Container(
                        ...
                        _getBt("所在班级", "images/admin/icon-class.png", _setUserClass, store.state.userInfo.className ?? "", 1),
                        Container(
                          width: ScreenUtil.getInstance().getWidthPx(903),
                          height: ScreenUtil.getInstance().getHeightPx(3),
                          decoration: new BoxDecoration(
                        ...
                        _getBt("我的老师", "images/admin/icon-teacher.png", null, store.state.userInfo.tRealName ?? "", 2),
                        Container(
                          width: ScreenUtil.getInstance().getWidthPx(903),
                          height: ScreenUtil.getInstance().getHeightPx(3),
                          decoration: new BoxDecoration(
                        ...
                        _getBt("所选教程", "images/admin/icon-course.png", () {
                          _setTextBook(store);
                        }, store.state.userInfo.textbookId == 1 ? "RJ版" : "BS版" ?? "", 1),
                        Container(
                          width: ScreenUtil.getInstance().getWidthPx(903),
                          height: ScreenUtil.getInstance().getHeightPx(3),
                          decoration: new BoxDecoration(
                        ...
                        _getBt("手机号码", "images/admin/icon-phone.png", () {
                          _resetMobile(store);
...
//                      border: new Border.all(color: Color(0xFFa6a6a6)),
                  ...
                  Container(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        _getBt("当前版本", "images/admin/icon-edition.png", _downldApp, store.state.application.version, 3, store: store),
                        Container(
                          width: ScreenUtil.getInstance().getWidthPx(903),
                          height: ScreenUtil.getInstance().getHeightPx(3),
                          decoration: new BoxDecoration(
                        ...
                        _getBt("清除缓存", "images/admin/icon-dele.png", _cacheSizeStrOnput, _cacheSizeStr, 1),
                        Container(
                          width: ScreenUtil.getInstance().getWidthPx(903),
                          height: ScreenUtil.getInstance().getHeightPx(3),
                          decoration: new BoxDecoration(
  ...
  _getBt(btName, btImg, btPressed, btMsg, type, {Store<GSYState> store}) {
    ...
    switch (type) {
      case 1:
        ...
        break;
      case 3:
        icon = store.state.application.canUpdate
            ? Container(
                ...
                child: Align(
                    ...
                    child: Text(
                      "更新",
                      style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(26 / 3), color: Color(0xFFe94049)),
                    )),
                decoration: BoxDecoration(
                  color: Colors.white,
          ...
          Container(
            child: Row(
              children: <Widget>[
                Text(
                  btMsg,
                  style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(38 / 3), color: Color(0xFFacb3be)),
                ),
                icon,
              ],
            ),

                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: RichText(
                              ...
                              TextSpan(text: "该栏目设置的时间，会同时在“远大小状元学生”和“${Config.TITLE}”app生效。为了孩子的用眼健康着想,我们建议每天连续在线学习时间不要超过"),
                              TextSpan(text: "1小时", style: TextStyle(color: Color(0xFFff9494))),
                              TextSpan(text: "。"),
                            ], style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(48 / 3), color: Color(0xFF959595)))),
                          ),
                          Column(
                          ...
                          Padding(
                            ...
                            ], style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(42 / 3), color: Color(0xFFff9494)))),
                          ),
                        ],
                      ),
  ...
  _getTimeListWidget() {
    ...
    for (var i = 0; i < timeList.length; i++) {
      var widgetList = Padding(
        ...
        child: MaterialButton(
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),
          onPressed: _timeName != timeList[i]
              ? () async {
          ...
          child: Text(
            timeList[i],
            style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(54 / 3), color: _timeName == timeList[i] ? Color(0xFFa83530) : Color(0xFF999999)),
          ),
        ),
      );

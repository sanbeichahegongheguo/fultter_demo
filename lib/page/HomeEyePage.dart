...
class _HomeEyePage extends State<HomeEyePage> with AutomaticKeepAliveClientMixin<HomeEyePage>, SingleTickerProviderStateMixin, WidgetsBindingObserver {
  //护眼图标初始位置
  double xPosition = ScreenUtil.getInstance().screenWidth - ScreenUtil.getInstance().getWidthPx(136);
  ...
  Map<String, String> _times = {"normal": '0', "really": '0'}; //时间统一存储
                  ...
                  child: Center(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            _fontBasic('眼睛疲劳', 0xfffd5252, textWeight: FontWeight.w700),
...
//                                        }),
                            ...
                            CommonUtils.buildBtn("退出APP",
                                ...
                                splashColor: Color(0xffd3d4d6), onTap: () {
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              _fontBasic('眼睛舒适', 0xff9acd43, textWeight: FontWeight.w700),
                              new Container(height: 5.0),
                              _fontBasic('已经连续学习', 0xffaeaeae, textSize: 18.0, textMain: countTime.toString(), textEnd: '分钟', textMainColor: 0xff9acd43),
                              new Container(height: 5.0),
                              Image.asset(
                                'images/eye/bBg.png',
                                width: ScreenUtil.getInstance().getWidthPx(312),
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                padding: new EdgeInsets.only(left: 44.0, right: 44.0, top: 15.0, bottom: 15.0),
                                child: _fontBasic('如需修改每次在线时间，您可以在', 0xff333333,
                                    textSize: 16.0, textMain: '管理>护眼模式', textEnd: '设置', textMainColor: 0xff333333, mainWeight: FontWeight.w800),
                                decoration: new BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          CommonUtils.buildBtn("30分钟",
                              width: ScreenUtil.getInstance().getWidthPx(646),
                              height: ScreenUtil.getInstance().getHeightPx(135),
  ...
  void controlPosition(tapInfo) {
    setState(() {
      ...
      if (yPosition < 45) {
        yPosition = 45;
        //最大限制
      } else if (yPosition > ScreenUtil.getInstance().screenHeight - ScreenUtil.getInstance().getWidthPx(136)) {
        yPosition = ScreenUtil.getInstance().screenHeight - ScreenUtil.getInstance().getWidthPx(136);
      }
    });
  }

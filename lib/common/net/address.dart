...
//  static const String sw_api_ = "https://api.k12china.com/sw/api/v1/";
  ...
  ///跳转到课程中心
  static goCourseCenter(){
    return "${Address.h5Host}courseCenter/index.html";
  }

  ///跳转到课程中心
  static goBroadcastHor(){
    return "${Address.h5Host}broadcast-hor/index.html";
  }
  ///获取未读取消息总数

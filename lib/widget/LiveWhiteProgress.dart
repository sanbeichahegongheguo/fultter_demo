...
class LiveWhiteProgressBar extends StatelessWidget {
  LiveWhiteProgressBar({
    this.onDragEnd,
    this.onDragStart,
    this.onDragUpdate,
    FlickProgressBarSettings flickProgressBarSettings,
  }) : flickProgressBarSettings = flickProgressBarSettings != null ? flickProgressBarSettings : FlickProgressBarSettings();
...
//    FlickVideoManager videoManager = Provider.of<FlickVideoManager>(context);
    VideoPlayerValue videoPlayerValue = VideoPlayerValue();
...
//    if (videoPlayerValue == null) return Container();
    ...
    void seekToRelativePosition(Offset globalPosition) {
      ...
      final Duration position = Duration(seconds: 20) * relative;
    ...
    for (DurationRange range in value.buffered) {
      ...
      Paint bufferedPaint = flickProgressBarSettings.getBufferedPaint != null
          ? flickProgressBarSettings.getBufferedPaint(
              width: width, height: height, playedPart: playedPart, handleRadius: handleRadius, bufferedStart: start, bufferedEnd: end)
          : Paint()

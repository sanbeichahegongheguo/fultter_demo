...
class LivesQuesManyWidget extends StatefulWidget {
  final bool isReplay;

  const LivesQuesManyWidget({Key key, this.isReplay = false}) : super(key: key);
  @override
  _LivesQuesManyWidgetState createState() => _LivesQuesManyWidgetState();
}

class _LivesQuesManyWidgetState extends State<LivesQuesManyWidget> {
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: CommonUtils.buildBtn("确定",
                        ...
                        decorationColor: Color(0xFF4E6EF2),
  ...
  _getOption(int index, RoomSelProvider model) {
    return FRadio(
      ...
      width: ScreenUtil.getInstance().getWidthPx(62),
      height: ScreenUtil.getInstance().getWidthPx(62),
      value: index + 1,
      ...
      selectedColor: Color(0xff4E6EF2),
      hasSpace: false,
      border: 0,
      child: Container(
          width: ScreenUtil.getInstance().getWidthPx(62),
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(color: Color(0xff4E6EF2), fontSize: 16),
            ),
          )),
      hoverChild: Text(
        "${(model.op != null && model.op.length == 1) ? model.op[index] : _selBtnName[index]}",

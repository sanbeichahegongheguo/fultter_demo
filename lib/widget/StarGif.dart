  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: FSuper(
        ...
        child1: AnimatedBuilder(animation: _animation, builder: (context,_){
              ...
              child: Consumer<_ImageProvider>(builder: (context, model, child) {
                return Column(
                  children: <Widget>[
                    ...
                    model.index==3?Text("提前进入课堂奖励${widget.starNum}颗星星",style: TextStyle(color: Colors.yellowAccent),):Container()
                  ],
                );
              }),
            ),

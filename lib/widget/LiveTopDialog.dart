    ...
    return ScaleTransition(
      ...
      child: FSuper(
        ...
        child1: FSuper(
          ...
          child1: Image.asset("images/live/top/icon.png",
          ...
          child2: Container(
            child: Column(
              ...
              children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Text(widget.data.length>1?"2.${widget.data[1]["name"]}":"",style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(6),color: Colors.grey, decoration: TextDecoration.none,fontWeight: FontWeight.normal))
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Text(widget.data.length>0?"1.${widget.data[0]["name"]}":"",style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(6),color: Colors.deepOrangeAccent, decoration: TextDecoration.none,fontWeight: FontWeight.normal))
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Text(widget.data.length>2?"3.${widget.data[2]["name"]}":"",style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(6),color: Colors.grey, decoration: TextDecoration.none,fontWeight: FontWeight.normal))
                        ],
                      ),
                    )
                  ],
                ...
                Text("恭喜以上同学最快回答问题！",style: TextStyle(fontSize: ScreenUtil.getInstance().getSp(6),color: Colors.grey, decoration: TextDecoration.none,fontWeight: FontWeight.normal)),
              ],
            ),
          ),
        ),
        child2: Image.asset("images/live/top/closeBtn.png",
